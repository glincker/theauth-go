...
- **v2.0 phase 5 + 6 (planned, separate PRs)**: `mcpresource` SDK, admin + account UX. Full v2.0 design at `/Users/gdsks/G-Development/GLINRV5/docs-local/2026-06-20-theauth-go-v2.0-design.md`.
